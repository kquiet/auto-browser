...
public class ActionTest {
  ...
  private static ExpectedCondition<?> mergeFrameExpectedCondition(List<By> frameSequence,
        ...
        (Request req) -> {
          ...
          if (RqMethod.GET.equalsIgnoreCase(method)) {
            return new RsWithStatus(
                new RsWithType(
                    new RsWithBody(new String(Files.readAllBytes(
                        Paths.get(new File(fileUrl.getFile()).getAbsolutePath())))), "text/html"),
                200);
          } else {
                ...
                new FkRegex("/postform", 
                    (Request req) -> {
                      ...
                      if (RqMethod.POST.equalsIgnoreCase(method)) {
                        ...
                        return new RsWithStatus(new RsWithBody("method is not POST:" + method),
                            200);
                      }
                    }
                ),
        ...
        .prepareActionSequence()
          ...
          .then()
            .custom(ac -> {
              ...
              ac.addToTail(
                  new Custom((Consumer<ActionComposer>)iac -> sb.append("D"), null));
            })
  ...
  public void click() {
    ...
    Function<Boolean, ActionComposer> composerSupplier = (flag) ->
        ...
        .prepareActionSequence()
          .waitUntil(mergeFrameExpectedCondition(frameSequence.get(),
            ExpectedConditions.visibilityOfElementLocated(By.id("btnClick"))), 3000)
          .prepareClick(By.id("btnClick")).withInFrame(frameSequence.get()).done()
          .waitUntil(mergeFrameExpectedCondition(frameSequence.get(),
            ExpectedConditions.visibilityOfElementLocated(By.id("divClickResult"))), 1000)
        .returnToComposerBuilder()
  ...
  public void mouseOver() {
    ...
    Function<Boolean, ActionComposer> composerSupplier = (flag) -> getDefinedActionComposerBuilder()
        .prepareActionSequence()
          ...
          .waitUntil(mergeFrameExpectedCondition(frameSequence.get(),
              ExpectedConditions.visibilityOfElementLocated(By.id("spMouseOver"))), 1000)
        .returnToComposerBuilder()
  ...
  public void sendKeys() {
    ...
    Function<Boolean, ActionComposer> composerSupplier = (flag) -> getDefinedActionComposerBuilder()
        .prepareActionSequence()
          ...
          .prepareSendKey(By.id("txtSendKey"), "clearbeforesend")
            .withClearBeforeSend().withInFrame(frameSequence.get()).done()
          .prepareWaitUntil(mergeFrameExpectedCondition(frameSequence.get(),
              ExpectedConditions.attributeToBe(
                  By.id("txtSendKey"), "value", "clearbeforesend")), 1000)
            .withTimeoutCallback(ac -> {
              try {
                WebDriver driver = ac.getWebDriver();
                WebElement inputE = driver.findElements(
                    By.id("txtSendKey")).stream().findFirst().orElse(null);
                actualValue.set(Optional.ofNullable(
                    inputE == null ? null : inputE.getAttribute("value")).orElse(""));
                ac.skipToFail();
              } catch (Exception ex) {
          ...
          .prepareWaitUntil(mergeFrameExpectedCondition(frameSequence.get(),
              ExpectedConditions.attributeToBe(
                  By.id("txtSendKey"), "value", "clearbeforesendsendwithoutclear")), 1000)
            .withTimeoutCallback(ac -> {
              try {
                WebDriver driver = ac.getWebDriver();
                WebElement inputE = driver.findElements(By.id("txtSendKey"))
    ...
    BiConsumer<Boolean, ActionComposer> assertConsumer = (flag, ac) -> assertAll(
        ...
        () -> assertTrue(ac.isSuccessfulDone(), "composer fail,"
            + "actualValue:" + actualValue.get() + frameIdentifier(flag)));
  ...
  public void select() {
    ...
    Function<Boolean, ActionComposer> composerSupplier = (flag) -> getDefinedActionComposerBuilder()
        .prepareActionSequence()
          .waitUntil(mergeFrameExpectedCondition(frameSequence.get(),
              ExpectedConditions.visibilityOfElementLocated(By.id("slcSelect"))), 3000)
          .prepareSelect(By.id("slcSelect")).selectByText("option2")
            .withInFrame(frameSequence.get()).done()
          .prepareWaitUntil(mergeFrameExpectedCondition(frameSequence.get(),
              ExpectedConditions.attributeToBe(By.id("slcSelect"), "value", "optionValue2")), 1000)
            .withTimeoutCallback(ac -> {
              try {
                WebDriver driver = ac.getWebDriver();
                WebElement inputE = driver.findElements(By.id("slcSelect"))
                    .stream().findFirst().orElse(null);
                actualValue.set(Optional.ofNullable(
                    inputE == null ? null : inputE.getAttribute("value")).orElse(""));
                ac.skipToFail();
  ...
  public void openAndCloseWindow() {
    ActionComposer actionComposer = getEmptyActionComposerBuilder()
        .prepareActionSequence()
          .prepareOpenWindow().registerAs("newwindow").done()
          .custom(ac -> {
          ...
          .closeWindow(true)
          .custom(ac -> {
            if (ac.getWebDriver().getWindowHandles()
  ...
  public void scrollToView() {
    ...
    Function<Boolean, ActionComposer> composerSupplier = (flag) -> getDefinedActionComposerBuilder()
        .prepareActionSequence()
          .waitUntil(mergeFrameExpectedCondition(frameSequence.get(),
              ExpectedConditions.visibilityOfAllElementsLocatedBy(By.id("divScroll"))), 1000)
          .prepareCustom(ac -> {
            WebElement element = ac.getWebDriver().findElements(By.id("divScroll"))
                .stream().findFirst().orElse(null);
            Long top = (Long)((JavascriptExecutor) ac.getWebDriver())
    ...
    BiConsumer<Boolean, ActionComposer> assertConsumer = (flag, ac) -> assertAll(
        () -> assertDoesNotThrow(
            () -> browserRunner.executeComposer(ac).get(5000, TimeUnit.MILLISECONDS),
            "not complete in time"),
        () -> assertTrue(initPosition.get() > 0 && afterPosition.get() == 0,
            String.format("scroll error, initial:%s, after:%s",
  ...
  public void upload() {
    ...
    Function<Boolean, ActionComposer> composerSupplier = (flag) -> getDefinedActionComposerBuilder()
        .prepareActionSequence()
          .waitUntil(mergeFrameExpectedCondition(frameSequence.get(),
              ExpectedConditions.presenceOfElementLocated(By.id("flUpload"))), 1000)
          .prepareUpload(By.id("flUpload"),
              new File(entryHtmlFileUrl.getFile()).getAbsolutePath())
              .withInFrame(frameSequence.get()).done()
              .waitUntil(mergeFrameExpectedCondition(frameSequence.get(),
                  ExpectedConditions.visibilityOfElementLocated(By.id("flUpload"))), 1000)
          .prepareCustom(ac -> {
            WebElement element = ac.getWebDriver().findElements(
                By.id("flUpload")).stream().findFirst().orElse(null);
            String name = (String)((JavascriptExecutor) ac.getWebDriver())
    ...
    BiConsumer<Boolean, ActionComposer> assertConsumer = (flag, ac) -> assertAll(
        () -> assertDoesNotThrow(
            () -> browserRunner.executeComposer(ac).get(5000, TimeUnit.MILLISECONDS),
            "not complete in time" + frameIdentifier(flag)),
        () -> assertEquals(ENTRY_HTML_FILE_NAME, fileName.get(),
  ...
  public void replyAlert() {
    ActionComposer actionComposer = getDefinedActionComposerBuilder()
        .prepareActionSequence()
          ...
          .prepareReplyAlert(ReplyAlert.Decision.Accept)
            .withTextAsVariable("AlertMessage").withKeysToSend("AlertInput").done()
          .waitUntil(ExpectedConditions.and(
    ...
    assertAll(
        () -> assertDoesNotThrow(
            ...
            "not complete in time"),
        () -> assertEquals("PromptMessage", actionComposer.getVariable("AlertMessage"),
  ...
  public void extract() {
    ...
    BiConsumer<Boolean, ActionComposer> assertConsumer = (flag, ac) -> assertAll(
        () -> assertDoesNotThrow(
            () -> browserRunner.executeComposer(ac).get(5000, TimeUnit.MILLISECONDS),
            "not complete in time" + frameIdentifier(flag)),
        () -> assertEquals("6. mouseover", ac.getVariable("varMouseOver1" + frameIdentifier(flag)),
            "text of #divMouseOver not saved as variable or not equal" + frameIdentifier(flag)),
        () -> assertEquals("txtSendKey", ac.getVariable("varSendKey1" + frameIdentifier(flag)),
            "id of #txtSendKey not saved as variable or not equal" + frameIdentifier(flag)),
        () -> assertEquals("pre-populated", ac.getVariable("varSendKey2" + frameIdentifier(flag)),
            "value of #txtSendKey not saved as variable or not equal" + frameIdentifier(flag)),
        () -> assertTrue(ac.isSuccessfulDone(), "composer fail" + frameIdentifier(flag)));
