...
public class PausablePriorityThreadPoolExecutor extends PausableThreadPoolExecutor {
   ...
   */
  public PausablePriorityThreadPoolExecutor(String poolPrefix, int corePoolSize,
      int maximumPoolSize) {
   ...
   */
  public PausablePriorityThreadPoolExecutor(String poolPrefix, int corePoolSize,
      int maximumPoolSize, Consumer<Runnable> afterExecuteFunc) {
   ...
   */
  public PausablePriorityThreadPoolExecutor(String poolPrefix, int corePoolSize,
      int maximumPoolSize, int queueSize, Consumer<Runnable> afterExecuteFunc) {
   ...
   */
  public PausablePriorityThreadPoolExecutor(String poolPrefix, int corePoolSize,
      int maximumPoolSize, int queueSize, long keepAliveTime, TimeUnit unit,
      Consumer<Runnable> afterExecuteFunc) {
    super(poolPrefix, corePoolSize, maximumPoolSize, keepAliveTime, unit,
