...
/**
 * {@link ActionRunner} is resposible to run a browser through <a href="https://github.com/SeleniumHQ/selenium" target="_blank">Selenium</a>
 * and execute actions against it. With its methods of
 * {@link #executeComposer(org.kquiet.browser.ActionComposer) executeComposer} and
 * {@link #executeAction(java.lang.Runnable, int) executeAction}, users can run
...
public interface ActionRunner extends Closeable {
   ...
   * @return a {@link CompletableFuture} representing the pending completion of given
   *     {@link ActionComposer}
   */
