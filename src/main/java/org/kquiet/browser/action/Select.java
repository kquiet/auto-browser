 ...
 * SELECT element. {@link org.openqa.selenium.StaleElementReferenceException} may happen while
...
public class Select extends MultiPhaseAction {
  ...
  public String toString() {
    return String.format(
        ...
        String.join(
            ",",
            Arrays.asList(options).stream().map(s -> s.toString()).collect(Collectors.toList())),
        String.join(
