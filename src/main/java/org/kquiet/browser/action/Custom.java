 ...
 *
 * <ol>
 *   <li>{@link Custom#Custom(java.util.function.Function, java.util.List) } is used to make {@link
 *       Custom} act as a {@link MultiPhaseAction}, therefore {@link MultiPhased#noNextPhase()} must
 *       be called explicitly before ending custom action.
 *   <li>{@link Custom#Custom(java.util.function.Consumer, java.util.List) } is used to make {@link
 *       Custom} act as a {@link SinglePhaseAction}.
 * </ol>
 *
 * @author Kimberly
 */
public class Custom extends MultiPhaseAction {
   ...
   */
  public Custom(
      Function<MultiPhased, Consumer<ActionComposer>> customAction, List<By> frameBySequence) {
  ...
  public String toString() {
    return String.format(
        ...
        String.valueOf(actAsSinglePhase),
        String.join(
