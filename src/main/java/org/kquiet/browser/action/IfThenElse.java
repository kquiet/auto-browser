 ...
 */
@NonBrowserable
public class IfThenElse extends SinglePhaseAction implements DynamicActionSequence {
  ...
  protected void performSinglePhase() {
    try {
      ...
      while (index < temp.size() && !isFail() && !getComposer().skipped()) {
        ...
        if (anyActionFail || getComposer().skipped()) {
          break;
        }
  ...
  /**
   * Add action to the head of positive or negative list. It depends on the evaluation result and
   * does nothing before evaulation.
   */
  @Override
  ...
  /**
   * Add action to the tail of positive or negative list. It depends on the evaluation result and
   * does nothing before evaulation.
   */
  @Override
  ...
  /**
   * Add action to the the specified position of positive or negative list. It depends on the
   * evaluation result and does nothing before evaulation.
   */
  @Override
